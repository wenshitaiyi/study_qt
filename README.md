...
详细学习规划与场景说明请参阅 [学习大纲.md](file:///d:/zcode/study/study_qt/学习大纲.md)。
...
# 5. 直接运行指定 Demo（自动添加 Qt DLL 到运行时 PATH）
...
详细目录与场景介绍见 [学习大纲.md](file:///d:/zcode/study/study_qt/学习大纲.md)。
